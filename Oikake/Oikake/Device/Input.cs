...
namespace Oikake.Device
{
    static class Input
    {
        ...
        private static KeyboardState previousKey;//1フレーム前のキー状態
        //マウス
        private static MouseState currentMouse;//現在のマウスの状態
        private static MouseState previousMouse;//1フレーム前のマウス状態
        ...
        ///マウスの左ボタンが離された瞬間か？
        ///</summary>
        ///<returns>現在はなされていて、１フレーム前に押されていたらtrue</returns>
        ...
        ///マウスのスクロールホイールの変化量
        ///</summary>
        ///<returns>１フレーム前と現在のホイールの差分</returns>
