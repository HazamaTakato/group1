...
{
    class HantaiNanameBound:Character
    {
        private Vector2 velocity;//移動量
        private static Random rnd = new Random();

        public HantaiNanameBound(IGameMediator mediator) : base("black",mediator)
        {
        ...
        public override void Hit(Character other)
        {
            ...
            //死んだら敵を増やす
            mediator.AddActor(new HantaiNanameBound(mediator));//新規に敵を追加
            mediator.AddActor(new HantaiNanameBound(mediator));//新規に敵を追加
